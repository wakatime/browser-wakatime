...
class WakaTimeCore {
                  ...
                  .then((tabs) => {
                    ...
                    if (items.loggingStyle == "blacklist") {
                      if (!contains(currentActiveTab.url, items.blacklist)) {
                        ...
                        console.log(
                          currentActiveTab.url + " is on a blacklist."
                        );
                      }
                    }
                    ...
                    if (items.loggingStyle == "whitelist") {
                      ...
                      if (heartbeat.url) {
                        ...
                        console.log(
                          currentActiveTab.url + " is not on a whitelist."
                        );
                      }
                    }
                  });
  ...
  getHeartbeat(url, list) {
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      var projectIndicatorIndex = cleanLine.lastIndexOf(
      ...
      var cleanUrl = url
        ...
        .replace(/^(?:https?:\/\/)?/i, "");
      var startsWithUrl =
        cleanUrl.toLowerCase().indexOf(urlFromLine.toLowerCase()) > -1;
      if (startsWithUrl) {
        return {
